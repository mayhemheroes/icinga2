...
* Windows: Update bundled versions of Boost and OpenSSL. #9360 #TODO (OpenSSL)

### Icinga DB

* Add an `icingadb` CheckCommand to allow checking if Icinga DB is healthy. #TODO
* Update documentation related to Icinga DB. #TODO
...
* Rename some attributes to make the database schema more consistent. #9399

...
bool Expression::GetReference(ScriptFrame&, bool, Value*, String*, DebugHint**) const
{
	return false;
}
...
bool VariableExpression::GetReference(ScriptFrame& frame, bool, Value *parent, String *index, DebugHint **dhint) const
{
	*index = m_Variable;
...
bool DerefExpression::GetReference(ScriptFrame& frame, bool, Value *parent, String *index, DebugHint**) const
{
	ExpressionResult operand = m_Operand->Evaluate(frame);
